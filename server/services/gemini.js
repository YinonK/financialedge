...
/**
 * Server-side Gemini 2.0 Flash client.
 *
 * SECURITY: GEMINI_API_KEY lives only in process.env (from .env, git-ignored).
 * It is read here and NOWHERE else. No route ever echoes it back in a
 * response body, and the frontend has no code path that could receive it.
 * (An earlier version of this project leaked this key to the browser twice —
 * treat keeping it server-side as a hard, non-negotiable requirement.)
 */
...
/**
 * @param {string} systemInstruction - persona / rules for The Brain
